 ...
 * @LastEditTime: 2026-01-12 18:41:08
...
<template>
  <div>
    ...
    <el-row :gutter="5">
      ...
      <el-col :span="3">
        <el-button style="border-radius: 20px;" type="danger" v-bind="publishBtn">publishBlog</el-button>
      </el-col>
    </el-row>
    <el-row>
      <mavon-editor v-model="content" style="margin: 10px;min-height: 70vh"/>
    </el-row>
